...
export default function RegisterPage() {
  ...
  const handleGoogleResponse = async (response) => {
    try {
      ...
      router.push('/');
    } catch { toast.error('Google sign-up failed. Try email registration.'); }
  };
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // If email service not configured — auto logged in
      if (res.data.token) {
        setAuth(res.data.user, res.data.token);
      ...
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-500 mt-1 text-sm">
            {step === 'form'
              ? 'Join thousands of Kenyans shopping smarter.'
              ...
              <div>
                ...
                <div className="relative">
                  <input type={showPass ? 'text' : 'password'} value={form.password}
                    ...
                    className="input-field pr-16" placeholder="Min. 6 characters" required minLength={6} />
              ...
              <div>
                ...
                <div className="relative">
                  <input type={showConfirm ? 'text' : 'password'} value={form.confirm}
                    ...
                    className={`input-field pr-16 ${form.confirm && form.password !== form.confirm ? 'border-red-400' : ''}`}
        ...
        {step === 'verify' && (
          <div className="card space-y-5">
            ...
            <div className="text-center space-y-2">
              ...
              <p className="text-xs text-gray-400">Also check your spam/junk folder</p>
            </div>
