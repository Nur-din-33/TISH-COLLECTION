    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-50 px-4">
        <div className="card text-center max-w-md w-full">
          ...
          <p className="text-gray-500 text-sm mb-4">This link is missing a token. Please request a new one.</p>
      ...
      <div className="w-full max-w-md">
        ...
        {done ? (
          <div className="card text-center">
            ...
            <p className="text-gray-500 text-sm mb-5">Your password has been updated. You can now log in.</p>
